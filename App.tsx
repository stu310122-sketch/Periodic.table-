...
import { VisualizationsView } from './src/components/VisualizationsView';
        ...
        <div className="wood-border-container">
            ...
            <div className={`wood-border-inner transition-opacity duration-300 opacity-100`}>
                <Routes>
                    ...
                    <Route path="/visualizations" element={<VisualizationsView elements={elements} onBack={backToHome} />} />
